...
case class WandererProfileErrorResponse(loginDetailsErrors: List[ErrorResponse], addressErrors: List[ErrorResponse], contactDetailsErrors: List[ErrorResponse])
