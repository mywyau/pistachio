  ...
  val insertOfficeSpecificationData: doobie.Fragment = {
    sql"""
        INSERT INTO office_specifications (
          ...
          ('BUS002', 'OFF002', 'Satellite Office', 'A compact office for remote teams.', 'SharedOffice', 1, 10, 30, ARRAY['Coffee', 'WiFi'], '{"days":["Tuesday","Thursday"],"openingTime":"09:00:00","closingTime":"16:00:00"}'::jsonb, 'Keep noise levels low.', '2025-01-01 12:00:00', '2025-01-01 12:00:00'),
