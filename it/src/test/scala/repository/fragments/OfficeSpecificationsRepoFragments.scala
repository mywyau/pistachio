  ...
  val insertOfficeSpecificationData: doobie.Fragment =
    sql"""
      INSERT INTO office_specifications (
        ...
        ('businessId1', 'officeId1', 'Main Office', 'some office description', 'PrivateOffice', 
         3, 3, 50, ARRAY['WiFi', 'Parking'],
         '{
           "openingHours": [
             { "closingTime": "17:00:00", "day": "Monday", "openingTime": "09:00:00" },
             { "closingTime": "17:00:00", "day": "Tuesday", "openingTime": "09:00:00" }
           ]
         }', 
