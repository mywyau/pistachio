...
CREATE TABLE bookings (
    ...
    userId INT NOT NULL REFERENCES user_profile(id) ON DELETE CASCADE,  -- Foreign key to users table (user who made the booking)
...
CREATE INDEX idx_user_id_bookings ON bookings (userId);
